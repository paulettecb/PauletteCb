...
2. **Estructura fija**: portada (sello + h1 Friendship + subtítulo Farmhouse + chips pastel), índice clickeable, capítulos con eyebrow Farmhouse, y cierre con glosario/chuleta.
...
5. **Lector KYN obligatorio**: el bloque de accesibilidad de lectura (lectura biónica con 3 niveles, regla que sigue el cursor, tamaño A−/A+, localStorage, oculto en print). Copiarlo desde `libro-agility.html` (bloques marcados `LECTOR KYN` en CSS y al final del body).
