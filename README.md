...
A modern, playful, privacy-first personal page with a lighter frosted-glass look:
...
## Customize content
- Update text in `index.html` (structure) and `script.js` (translations).
- Update contact in `index.html`.
