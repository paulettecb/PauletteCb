...
4. **Fase 2 (desarrollo), SIGUIENTE:** escribir los mini libros KYN capítulo por capítulo contra su hoja de hechos + fact-check independiente (patrón de CLAUDE.md: lector KYN, Hanken Grotesk Black MAYÚSCULAS en títulos internos, alta en `build-all.mjs`, verificación Playwright). Sugerencia de orden: empezar por `libro-area2.html` (Intervención, la subárea de enfoques tiene 22 reactivos), luego `libro-area3.html`. La sección transversal se decide después — es de habilidad, no de contenido memorizable.
