...
4. **Fase 2 (desarrollo), EN CURSO:**
   ...
   - ✅ **Simulacro interactivo LISTO (2026-07-08):** `proyectos/ceneval/simulacro.html` (app KYN, commiteada) + `material/preguntas.json` (local, gitignored): **489 reactivos** extraídos de los 5 exámenes de `material/guías/` (3 docx con clave en rojo + 2 PDFs con justificaciones), 487 con clave y 224 con explicación. Clasificados por área (105/151/113 + 120 transversal); método y decisiones en `material/extraccion-examenes/NOTAS.md`. Modos: rondas por área, examen completo 140 (49+50+41), transversal con textos, solo redacción y repaso de errores; errores → CSV para Anki.
   - ✅ La sección transversal quedó cubierta por el simulacro (comprensión lectora con sus textos + redacción indirecta).
   - **Siguiente herramienta sugerida:** flashcards Anki desde las hojas de hechos, o chuletas imprimibles por área (ver README).
