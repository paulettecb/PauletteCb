// Shell de Lana: router por hash, encabezado con selector de mes, navegación
// y FAB de quick-add. Cada vista exporta render(el) y se re-renderiza completa
// cuando cambia el estado (los modales viven en otra capa, no se pierden).

import * as store from './store.js';
import { abrirQuickAdd } from './components.js';
import { nombreMes, sumarMeses, mesActualKey } from './utils.js';
  ...
  <div class="shell">
    <header class="encabezado">
      <div class="encabezado-inner">
        <a class="logo" href="#/resumen">Lana <span class="eyebrow">tu dinero, claro</span></a>
...
function renderZonaMes() {
  ...
  zonaMes.innerHTML = `
    ...
    <div class="selector-mes">
      ...
      <span class="mes-actual">${nombreMes(store.getMes())}</span>
